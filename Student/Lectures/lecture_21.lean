...
-- it is a set where membership is included to n satisfying the predicate, n=0 or 1 or 2 or 3 or 4
/-!
...
- What values are in the set, {1, 2, 3} ∩ {4, 5, 6}? none, will return empty set
...
/-!
Symmetric means a relates b is the same as b relating to a

Reflexive, a relates to a for any a. A EQUALS A

Transitive- when a is related b, b is related to c, thus a is related to c for some relation
