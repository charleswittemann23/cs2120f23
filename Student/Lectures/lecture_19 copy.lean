...
-- Dogs exist, Iris is one, Blueness predicate,
/-!
...
variable
  ...
  (Mortal : Person → Prop)-- gives property of morrtality to people
...
example:  (∃ (jim_ryan : Person ), (∀ (p: Person), Loves p jim_ryan)) → ∀ (p: Person), (∃( jim_ryan: Person), Loves p jim_ryan)
